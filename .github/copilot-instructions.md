...
- `scripts` contains the reusable composite actions used as building blocks by the workflows. Actions cover focused tasks such as checking versions, setting up .NET, building solutions, executing tests and handling artifacts.
